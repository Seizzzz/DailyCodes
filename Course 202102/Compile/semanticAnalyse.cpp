...
bool returnExistedCheckStatement(_Statement *statementNode); //检查当前语句是否是“返回值完备”的
void returnExistedCheckMainCompound(_Compound *compoundNode, string functionId, int functionLineNumber); //检查函数定义的程序体语句列表是否存在“返回值完备”的语句
void returnExistedCheckFunctionDefinition(_FunctionDefinition* functionDefinitionNode); //检查函数定义是否是“返回值完备”的
